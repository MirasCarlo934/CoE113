...
HD_PWD='D:/carlo/git/CoE113/mp02-project-files/mp02-project-files.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_v2.tcl
